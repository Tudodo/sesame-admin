...
const USER_PASSWORD: &str = "Test1234";
...
pub async fn init_user_login(request: &TestServer, ctx: &AppContext) -> LoggedInUser {
    ...
    request
        ...
        .await;
    let user = users::Model::find_by_email_in_tenant(&ctx.db, USER_EMAIL, DEFAULT_TENANT_CODE)
        .await
        .unwrap();
    ...
    LoggedInUser {
        user: users::Model::find_by_email_in_tenant(&ctx.db, USER_EMAIL, DEFAULT_TENANT_CODE)
            .await
            .unwrap(),
